...
def plot_backazimuths_on_imagery(backazimuths,big_event_backazimuth,array_centroid,station_grid_coords,colors):
    ...
    plt.savefig("outputs/backazimuths.png",bbox_inches="tight",dpi=100)
